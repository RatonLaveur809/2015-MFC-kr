...
// kr1_gembitskaya.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект Ckr1_gembitskayaApp

Ckr1_gembitskayaApp theApp;


// инициализация Ckr1_gembitskayaApp
...
// обработчики сообщений Ckr1_gembitskayaApp
...
// Ckr1_gembitskayaApp настройка методов загрузки и сохранения
